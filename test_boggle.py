import unittest #uses classes and inheritance
import boggle
...
class TestBoggle(unittest.TestCase):
    ...
    def test_grid_coordinates(self):
        ...
        self.assertNotIn((2,2), grid) #assert that 2,2 is not in a 2*2 grid 
    ...
    def test_converting_a_path_to_a_word(self): # turn a path/string of positions into a word/list of letters
        """
    ...
    def test_search_grid_for_words(self): # need to find words in the grid. need to ensure that certain patterns can be found in a path    
        """
